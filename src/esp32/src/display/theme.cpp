...
void theme_init(void) {
    ...
    // Get the default theme and modify it
    lv_theme_t* theme = lv_theme_default_init(
        lv_disp_get_default(),
        COLOR_ACCENT_AMBER,         // Primary color
        COLOR_ACCENT_ORANGE,        // Secondary color
    ...
    lv_style_set_bg_color(&style_btn_primary, COLOR_ACCENT_AMBER);
    ...
    lv_style_set_border_color(&style_btn_secondary, COLOR_ACCENT_AMBER);
